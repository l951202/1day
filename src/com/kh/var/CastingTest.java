...
public class CastingTest {
	...
	public void castMethod1() {
		...
		int num3 = 100;
		//char ch3 = num3;
		// 이미 int로4byte 공간을 할당 받은 num3은
		//2byte의 공간을 가진ch으로 옮길 수 없다.
	...
	public void castMethod2() {
		...
		// 3. 해당 데이터를 처리할 수 있는 가장 큰 자료형을 사용 하는경우
		double result3 = num1 + num2;
		
		System.out.println("result3:" + result3);
		
		// 4. byte와short는 사칙연산의 수행 결과가
